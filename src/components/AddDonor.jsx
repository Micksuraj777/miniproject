...
const AddDonor = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const allFields = ['name', 'age', 'contact', 'address', 'visionScore'];
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleChange}
                      onBlur={() => handleBlur('visionScore')}
                      required
                      min="0"
                      max="10"
                      step="0.1"
                      placeholder="Enter vision score"
                      className={`block w-full px-4 py-3 rounded-lg border ${
                        touched.visionScore && getInputError('visionScore')
                          ? 'border-red-500 focus:ring-red-500'
                          : 'border-gray-300 focus:ring-blue-500'
                      } focus:border-transparent focus:outline-none focus:ring-2 transition-colors`}
                    />
                    {touched.visionScore && getInputError('visionScore') && (
                      <p className="mt-1 text-sm text-red-500">{getInputError('visionScore')}</p>
                    )}
                  </div>
                </div>
              </div>
