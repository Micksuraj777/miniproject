...
const AddRecipient = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const allFields = [
      ...
      'hla_a', 'hla_b', 'hla_c', 'hla_dr', 'hla_dq', 'recipientUrgencyScore'
    ];
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              {/* Urgency Score */}
              <div className="mb-8">
                <h3 className="text-lg font-medium text-gray-800 mb-4 border-b pb-2">Recipient Urgency</h3>
                <div className="grid grid-cols-1 gap-6 md:grid-cols-1">
                  {renderScoreInput('recipientUrgencyScore', 'Recipient Urgency Score', 0, 10, 0.1)}
                </div>
              </div>
